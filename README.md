### Within the params.txt file add beneath commented sections with # symbol (do not change the comments):
## Actions in given format:
 {variable} := {variable} {operation} {variable} <br>
 ...
## Alphabet in given format (one symbol for each action):
 {symbol} <br>
 ...
## Word that is goin to be analyzed in given format:
